...
// Runs the plugin's eval suite (agent-plugins/spring-tools/evals) with GitHub Copilot CLI, the
// same way `claude plugin eval` runs it with Claude Code:
//
//   node agent-plugins/tools/evals/run-with-copilot.mjs [--case <name>] [--model <model>] [--keep]
//
