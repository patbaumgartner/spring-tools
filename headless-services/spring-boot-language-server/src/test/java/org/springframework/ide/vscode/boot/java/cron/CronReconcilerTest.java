...
public class CronReconcilerTest {
	...
	void DayOfTheWeekProblems_1() {
		...
		assertReconcileProblem(problems.get(0), CronProblemType.CRON_FIELD, 10, 6);
	}
	...
	void noProblems_3() {
		...
		assertEquals(1, problems.size());
		assertReconcileProblem(problems.get(0), CronProblemType.CRON_FIELD, 0, 7);
	}
	...
	void syntax_and_field_problems_1() {
		...
		assertReconcileProblem(problems.get(0), CronProblemType.CRON_SYNTAX, 7, 2);
		assertReconcileProblem(problems.get(1), CronProblemType.CRON_SYNTAX, 12, 5);		
		assertReconcileProblem(problems.get(2), CronProblemType.CRON_FIELD, 18, 2);		
	}
	...
	void syntax_problems_2() {
		...
		assertEquals(1, problems.size());
		assertReconcileProblem(problems.get(0), CronProblemType.CRON_SYNTAX, 0, 2);
	}
	...
	void syntax_problems_3() {
		...
		assertEquals(1, problems.size());
		assertReconcileProblem(problems.get(0), CronProblemType.CRON_SYNTAX, 4, 0);
	}
